...
public class ExtendQueryTest {
    private final String PG_SERVER_URL = "jdbc:postgresql://127.0.0.1:5432/willy?useUnicode=true&amp;characterEncoding=utf-8&amp;rewriteBatchedInserts=true&loglevel=2&rewriteBatchedStatements=true&preferQueryMode=extended";
    private final String PG_NETTY_URL = "jdbc:postgresql://127.0.0.1:6432/willy?useUnicode=true&amp;characterEncoding=utf-8&amp;rewriteBatchedInserts=true&loglevel=2&rewriteBatchedStatements=true&preferQueryMode=extended";
