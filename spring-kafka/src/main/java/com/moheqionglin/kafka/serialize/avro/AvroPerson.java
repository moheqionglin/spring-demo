...
public class AvroPerson extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static com.moheqionglin.kafka.serialize.avro.AvroPerson.Builder newBuilder() {
    return new com.moheqionglin.kafka.serialize.avro.AvroPerson.Builder();
  }
   ...
   * @return A new AvroPerson RecordBuilder
   */
  public static com.moheqionglin.kafka.serialize.avro.AvroPerson.Builder newBuilder(com.moheqionglin.kafka.serialize.avro.AvroPerson.Builder other) {
    if (other == null) {
      return new com.moheqionglin.kafka.serialize.avro.AvroPerson.Builder();
    } else {
      return new com.moheqionglin.kafka.serialize.avro.AvroPerson.Builder(other);
    }
  }
   ...
   * @return A new AvroPerson RecordBuilder
   */
  public static com.moheqionglin.kafka.serialize.avro.AvroPerson.Builder newBuilder(com.moheqionglin.kafka.serialize.avro.AvroPerson other) {
    if (other == null) {
      return new com.moheqionglin.kafka.serialize.avro.AvroPerson.Builder();
    } else {
      return new com.moheqionglin.kafka.serialize.avro.AvroPerson.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroPerson>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.moheqionglin.kafka.serialize.avro.AvroPerson.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.moheqionglin.kafka.serialize.avro.AvroPerson other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.moheqionglin.kafka.serialize.avro.AvroPerson.Builder setId(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.moheqionglin.kafka.serialize.avro.AvroPerson.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.moheqionglin.kafka.serialize.avro.AvroPerson.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.moheqionglin.kafka.serialize.avro.AvroPerson.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.moheqionglin.kafka.serialize.avro.AvroPerson.Builder setAge(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.moheqionglin.kafka.serialize.avro.AvroPerson.Builder clearAge() {
      age = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.moheqionglin.kafka.serialize.avro.AvroPerson.Builder setLon(java.lang.Float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.moheqionglin.kafka.serialize.avro.AvroPerson.Builder clearLon() {
      lon = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.moheqionglin.kafka.serialize.avro.AvroPerson.Builder setSuccess(java.lang.Boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.moheqionglin.kafka.serialize.avro.AvroPerson.Builder clearSuccess() {
      success = null;
