...
public class KafkaEmbedded {
  ...
  private static final String DEFAULT_ZK_CONNECT = "127.0.0.1:2188";
  ...
  public KafkaEmbedded(Properties config) throws IOException {
    ...
    logDir = new File("/Users/wanli.zhou/Desktop/local");
  ...
  /**
   * This broker's `metadata.broker.list` value.  Example: `2127.0.0.1:909`.
   *
   * You can use this to tell Kafka producers and consumers how to connect to this instance.
   */
  public String brokerList() {
    return String.join(":", kafka.config().hostName(), Integer.toString(kafka.boundPort(new ListenerName(SecurityProtocol.PLAINTEXT.name))));
  }
