package com.moheiqonglin.persistence.jpa.eclipseLinkJpa;
...
public class Main {
    ...
    public static void main(String[] args) {
        EntityManagerFactory entityManagerFactory = Persistence.createEntityManagerFactory("eclipseLink-jpa-unit");
